...
function Achievements() {
  ...
  const achievements = useMemo(() => [
    {
      id: 1,
      title: "3rd Place in ENSAT Hackathon",
      subtitle: "Innovation Competition 2025",
      description: "Successfully competed and secured 3rd place in a competitive hackathon, showcasing innovative problem-solving skills, technical expertise, and exceptional teamwork under pressure.",
